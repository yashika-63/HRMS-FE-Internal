    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (isUpdateMode) {
                ...
                await axios.post(`http://${strings.localhost}/api/ctcMasterData/saveMultiple/${companyId}`, formData);
    ...
    return (
        <div className="mastercontainer">
            <form onSubmit={handleSubmit}>
                <div className="form-title">CTC Master</div>
                    ...
                    <tbody>
                        {(searchResults.length > 0 ? searchResults : projects).map((master, index) => (
                            <tr key={master.masterId}>
                                ...
                                <td>{master.type === true ? 'Addition' : master.type === false ? 'Deduction' : ''}</td>
                            ...
                            <div>
                                ...
                                <div>
                                    ...
                                    <select
                                        ...
                                        value={formData.type === true ? "true" : formData.type === false ? "false" : ''}
                                    >
                                        <option value="">Select Type</option>
                                        <option value="true">Addition</option>
